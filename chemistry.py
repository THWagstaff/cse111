def main():
    ...
    list = parse_formula(formula, table)
    # Call the compute_molar_mass function to compute the
    # molar mass of the molecule from the compound list.
    molar = compute_molar_mass(list, table)
...
def compute_molar_mass(symbol_quantity_list, periodic_table):
    ...
    for i in symbol_quantity_list:
        NAME_INDEX = symbol_quantity_list(0)
        Quantity = symbol_quantity_list(1)
        atomic_mass = Quantity * ATOMIC_MASS_INDEX
        moles = Quantity / atomic_mass
