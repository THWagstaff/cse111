import random
def main():
    quantity = input("What is the quantity? (please type an integer): ")
    tense = input("What is the tense? (past, present, future) ")
...
def get_prepositional_phrase(quantity):
    ...
    noun = get_noun(quantity)
    preposition = get_preposition()
    #print(f'{preposition} {word} {noun}')
    prepphrase = (f'{preposition} {word} {noun}')
    return prepphrase
